...
{/* 
    <div className="spinner ml-[1350px] mt-[-50px]">
      ...
      <img className="mt-[140px] ml-[100px] " src="https://c4.wallpaperflare.com/wallpaper/899/694/436/fiction-collage-black-background-poster-wallpaper-thumb.jpg" />
      <div className="shine ml-[850px] mt-[-230px]">UNLIMITED MOVIES,<br/> TV SHOWS AND MORE .</div> 
      
       {/* button */}

      <Link href={'/Sign'}>
      <button className="get-button ml-[850px] mt-[10px]">
          Get Started
